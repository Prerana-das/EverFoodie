<template>
    <div>
		...
		<div class="container">
			<div class="row _padd_t100">
				<div class="col-lg-8">
					<div class="box_general write_review">
						<h1>Write a review of This Restaurant</h1>
						...
						<a href="confirm.html" class="block_btn">Submit review</a>
					</div>
				</div>
				<!-- /col -->
				<div class="col-lg-4">
					<div class="latest_review">
						...
						<div class="review_listing">
							...
							<ul class="clearfix">
								...
								<li><a href="reviews-page.html" class="block_btn small">Read review</a></li>
							</ul>
						</div>
						<!-- /review_listing -->
						<div class="review_listing">
